...
public class ExportTest {
	...
	public void exportAll() throws Exception {
		String[] args = new String[] { "-k", "ks_tsc", "-m", "-u", "cassandradbuser", "-p", "v7^bEWnuHaFXtXfv", "-po",
				"9042", "-s", "-f", "ks_tsc.sql", "--force", "--test" };
		Main.main(args);
		// String s = Files.toString(new File("ks_tsc.cql"), Charset.defaultCharset());
		// String s1 = Files.toString(new File("src/test/resources/ks_tsc.cql"),
	...
	public void exportOneTable() throws Exception {
		String[] args = new String[] { "-k", "cycling", "-t", "cyclist_races", "--force", "--test" };
		Main.main(args);
		String s = Files.toString(new File("cycling.CQL"), Charset.defaultCharset());
		String s1 = Files.toString(new File("src/test/resources/cycling.table.cyclist_races.expected.CQL"),
				Charset.defaultCharset());
		compareContent(s, s1);
	}
	...
	public void seperateTable() throws Exception {
		String[] args = new String[] { "-k", "iot_new", "-s", /* "--force", */ "--test" };
		Main.main(args);
		String s = Files.toString(new File("cycling.CQL"), Charset.defaultCharset());
		String s1 = Files.toString(new File("src/test/resources/cycling.table.cyclist_races.expected.CQL"),
				Charset.defaultCharset());
