<%@include file="/WEB-INF/pages/jspf/include.jspf" %> 
  ...
  <div class="form-group">
    ...
    <input path="email" type="email" class="form-control" data-error="Bruh, that email address is invalid" />
  ...
  <div class="form-group">
    ...
    <div class="form-inline row">
      <div class="form-group col-sm-6">
        <input path="password" type="password" data-minlength="6" class="form-control" />
        <div class="help-block">Minimum of 6 characters</div>
      </div>
      <div class="form-group col-sm-6">
        <input path="passwordConfirm" type="password" class="form-control" data-match="#password" data-match-error="Whoops, these don't match" />
        <div class="help-block with-errors"></div>
      </div>
    </div>
  </div>
